...
namespace Base.Helper
{
    public static class MyFile
    {
        ...
        public static async Task<string[][]> ReadStringMatrixFromCsvAsync(string fileName, bool overreadTitleLine,char separator)
        {
            ...
            {
                elements[line - subtractIndex] = lines[line].Split(separator);
            }
            return elements;
        }
